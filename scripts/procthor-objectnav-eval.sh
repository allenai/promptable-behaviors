...
OMP_NUM_THREADS=15 PYTHONPATH=. python procthor_objectnav/main_objectnav.py \
...
wandb.name=procthor-objectnav callbacks=procthor_objectnav/callbacks/wandb_logging.py \
