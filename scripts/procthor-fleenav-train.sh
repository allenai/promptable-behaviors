...
### FLEENAV ###
OMP_NUM_THREADS=45 PYTHONPATH=. python procthor_visual_nav/main_fleenav.py \
experiment=procthor_visual_nav/experiments/rgb_clipresnet50gru_ddppo_fleenav_morl \
...
wandb.name=fixed-weights-${reward_weights_string} callbacks=procthor_visual_nav/callbacks/wandb_logging.py \
