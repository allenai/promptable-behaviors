...
OMP_NUM_THREADS=15 PYTHONPATH=. python procthor_visual_nav/main_fleenav.py \
...
wandb.name=procthor-fleenav callbacks=procthor_visual_nav/callbacks/wandb_logging.py \
