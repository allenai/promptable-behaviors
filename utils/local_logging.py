...
from allenact.base_abstractions.sensor import Sensor
from procthor_armpointnav.ithor_arm.bring_object_tasks import ExploreWiseRewardTask
...
class LocalLoggingSensor(Sensor[Controller, ExploreWiseRewardTask]):
    def get_observation(
        self, env: Controller, task, *args: Any, **kwargs: Any
    ) -> Any:
