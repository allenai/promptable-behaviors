...
from procthor_visual_nav.algorithms.onpolicy_runner import OnPolicyRunner, CONFIG_KWARGS_STR
...
@hydra.main(config_path=os.environ["PROCTHOR_HYDRA_CONFIG_DIR"], config_name="main_fleenav")
