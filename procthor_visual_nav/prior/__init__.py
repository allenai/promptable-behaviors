...
from procthor_visual_nav.prior.lock import LockEx

# NOTE: These are unused in this file, but imported to other files.
# So, leave them here.
from procthor_visual_nav.prior.utils.types import Dataset, DatasetDict, LazyJsonDataset
    ...
    **kwargs: Any,
    ...
    try:
        ...
        if "eval" not in dataset:
            dataset_path = "../procthor-10k"
        else:
            dataset_path = "../object-nav-eval"
        os.chdir(dataset_path)
